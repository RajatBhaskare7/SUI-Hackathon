...
const PieChartCard = () => {
  return (
    <Card extra="rounded-[20px] p-3">
      ...
      <PieChart 
  options={{
    labels: ["Files", "System", "Others", "System", "Others", "System", "Others", "System", "Others"],  
    colors: ["#043750","#56457A","#2A4069","#CB4E5B","#84457D","#D0673C","#D08906","#D0673C","#AE4472", "#B05ABE", "#EFF4FB"],
    chart: {
      width: "50px",
    },
    states: {
